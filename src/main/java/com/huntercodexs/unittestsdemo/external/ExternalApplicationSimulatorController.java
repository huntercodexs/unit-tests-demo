...
public class ExternalApplicationSimulatorController {
    ...
    @ResponseBody
    public ResponseEntity<?> one(HttpServletRequest headers, @PathVariable("id") String id) {
    ...
    @ResponseBody
    public ResponseEntity<?> delete(HttpServletRequest headers, @PathVariable("id") String id) {
